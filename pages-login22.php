                  ...
                  <?php
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" id="yourUsername"  name="email" placeholder="enter email" class="form-control"required>
                    ...
                    <div class="col-12"> 
                      ...
                      <input type="password" class="form-control" id="yourPassword" name="password" placeholder="enter password"  required>
