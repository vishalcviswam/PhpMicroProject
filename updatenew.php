                ...
                <div class="card-body">
                  ...
                  <?php
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="phone" class="form-control" id="yourEmail" value="<?php echo $row["phone"]; ?>" required>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="email" class="form-control" id="yourUsername" value="<?php echo $row["email"]; ?>" required>
                    ...
                    <div class="col-12">
                      ...
                      <textarea name="address" class="form-control" id="yourName" rows="2" value="<?php echo $row["address"]; ?>" required></textarea>
